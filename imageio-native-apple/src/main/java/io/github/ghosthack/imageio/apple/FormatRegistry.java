...
/**
 * Registry of image formats supported by Apple's ImageIO, with metadata
 ...
 * with Apple-specific formats (JPEG 2000, JXL, PSD, EXR, GPU textures,
 * camera RAW, etc.).
 */
final class FormatRegistry {
    ...
    private static final List<Format> ALL_FORMATS = List.of(
        ...
        // JPEG XL
        new Format(a("JXL","jxl","JPEGXL"),        a("jxl"),                     a("image/jxl"),                      false),

        // Adobe PSD
        new Format(a("PSD","psd"),                 a("psd"),                     a("image/vnd.adobe.photoshop"),      false),

        // Icons / cursors
        new Format(a("ICO","ico"),                 a("ico"),                     a("image/x-icon"),                   false),
        new Format(a("ICNS","icns"),               a("icns"),                    a("image/x-icns"),                   false),
        new Format(a("CUR","cur"),                 a("cur"),                     a("image/x-win-bitmap"),             false),

        // HDR / scientific
        new Format(a("EXR","exr"),                 a("exr"),                     a("image/x-exr"),                    false),
        new Format(a("RADIANCE","hdr","rgbe"),     a("hdr","pic","rgbe"),        a("image/vnd.radiance"),             false),

        // Legacy / niche
        new Format(a("TGA","tga"),                 a("tga","targa"),             a("image/x-tga"),                    false),
        new Format(a("SGI","sgi"),                 a("sgi","rgb","bw"),          a("image/x-sgi"),                    false),
        new Format(a("PBM","pbm","PGM","pgm","PPM","ppm"), a("pbm","pgm","ppm"),a("image/x-portable-bitmap"),        false),
        new Format(a("PICT","pict"),               a("pict","pct"),              a("image/x-pict"),                   false),
        new Format(a("DDS","dds"),                 a("dds"),                     a("image/vnd.ms-dds"),               false),
        new Format(a("MPO","mpo"),                 a("mpo"),                     a("image/mpo"),                      false),
        new Format(a("DICOM","dcm"),               a("dcm","dicom"),             a("application/dicom"),              false),

        // GPU textures
        new Format(a("KTX","ktx"),                 a("ktx"),                     a("image/ktx"),                      false),
        new Format(a("KTX2","ktx2"),               a("ktx2"),                    a("image/ktx2"),                     false),
        new Format(a("ASTC","astc"),               a("astc"),                    a("image/astc"),                     false),
        new Format(a("PVR","pvr"),                 a("pvr"),                     a("image/x-pvr"),                    false),
        new Format(a("ATX","atx"),                 a("atx"),                     a("image/x-atx"),                    false),

        // Camera RAW (DNG + vendor)
        ...
        new Format(a("MOS","mos"),                 a("mos"),                     a("image/x-leaf-mos"),               false),
