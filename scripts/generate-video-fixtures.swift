...
func writeVideo(outputURL: URL, fileType: AVFileType) {
    ...
    for i in 0..<frameCount {
        ...
        // Frame times are relative to startTime
        let time = CMTime(value: startTime.value + CMTimeValue(i) * CMTimeValue(ts / fps),
                          timescale: ts)
...
print("Done")
print()
print("NOTE: test-video-3s-bframes.mp4 is generated by generate-video-bframes.sh (requires ffmpeg).")
